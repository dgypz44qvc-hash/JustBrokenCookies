...
(function(){
  ...
  formatBar.innerHTML = [
    ...
    '  <select id="jbc-font-family" title="Font family" style="max-width:160px;">',
    ...
    '      <option value="\'Lora\', serif" data-gf="Lora:400,700">Lora</option>',
    '      <option value="\'Merriweather\', serif" data-gf="Merriweather:300,400,700">Merriweather</option>',
    '      <option value="\'Cormorant Garamond\', serif" data-gf="Cormorant+Garamond:400,500,600,700">Cormorant Garamond</option>',
    '      <option value="\'EB Garamond\', serif" data-gf="EB+Garamond:400,500,700">EB Garamond</option>',
    '      <option value="\'Libre Baskerville\', serif" data-gf="Libre+Baskerville:400,700">Libre Baskerville</option>',
    '      <option value="\'Noto Serif\', serif" data-gf="Noto+Serif:400,700">Noto Serif</option>',
    '      <option value="Georgia, serif">Georgia</option>',
    '      <option value="\'Times New Roman\', serif">Times New Roman</option>',
    '    </optgroup>',
    '    <optgroup label="Sans-Serif">',
    '      <option value="\'Montserrat\', sans-serif" data-gf="Montserrat:300,400,500,600,700,900">Montserrat</option>',
    '      <option value="\'Poppins\', sans-serif" data-gf="Poppins:300,400,500,600,700">Poppins</option>',
    '      <option value="\'Raleway\', sans-serif" data-gf="Raleway:300,400,500,600,700">Raleway</option>',
    '      <option value="\'Open Sans\', sans-serif" data-gf="Open+Sans:300,400,600,700">Open Sans</option>',
    '      <option value="\'Roboto\', sans-serif" data-gf="Roboto:300,400,500,700">Roboto</option>',
    '      <option value="\'Nunito\', sans-serif" data-gf="Nunito:300,400,600,700">Nunito</option>',
    '      <option value="\'DM Sans\', sans-serif" data-gf="DM+Sans:400,500,700">DM Sans</option>',
    '      <option value="\'Josefin Sans\', sans-serif" data-gf="Josefin+Sans:300,400,600,700">Josefin Sans</option>',
    '      <option value="\'Bebas Neue\', sans-serif" data-gf="Bebas+Neue">Bebas Neue</option>',
    '      <option value="\'Oswald\', sans-serif" data-gf="Oswald:300,400,500,600,700">Oswald</option>',
    '      <option value="Arial, sans-serif">Arial</option>',
    '      <option value="\'Helvetica Neue\', Helvetica, sans-serif">Helvetica</option>',
    '      <option value="Verdana, sans-serif">Verdana</option>',
    '    </optgroup>',
    '    <optgroup label="Display">',
    '      <option value="\'Abril Fatface\', serif" data-gf="Abril+Fatface">Abril Fatface</option>',
    '      <option value="\'Righteous\', cursive" data-gf="Righteous">Righteous</option>',
    '      <option value="\'Cinzel\', serif" data-gf="Cinzel:400,600,700,900">Cinzel</option>',
    '      <option value="\'Poiret One\', cursive" data-gf="Poiret+One">Poiret One</option>',
    '      <option value="\'Archivo Black\', sans-serif" data-gf="Archivo+Black">Archivo Black</option>',
    '      <option value="Impact, sans-serif">Impact</option>',
    '    </optgroup>',
    '    <optgroup label="Script / Handwritten">',
    '      <option value="\'Great Vibes\', cursive" data-gf="Great+Vibes">Great Vibes</option>',
    '      <option value="\'Pacifico\', cursive" data-gf="Pacifico">Pacifico</option>',
    '      <option value="\'Sacramento\', cursive" data-gf="Sacramento">Sacramento</option>',
    '      <option value="\'Caveat\', cursive" data-gf="Caveat:400,700">Caveat</option>',
    '      <option value="\'Satisfy\', cursive" data-gf="Satisfy">Satisfy</option>',
    '    </optgroup>',
    '    <optgroup label="Monospace">',
    '      <option value="\'Space Mono\', monospace" data-gf="Space+Mono:400,700">Space Mono</option>',
    '      <option value="\'JetBrains Mono\', monospace" data-gf="JetBrains+Mono:400,500,700">JetBrains Mono</option>',
